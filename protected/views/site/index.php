...
<?php $this->widget('bootstrap.widgets.TbCarousel', array(
  'items'=>array(
	...
	<article class="Reseña">
		<p> <img style="border:0;width:95px;height:90px" src="./images/Condor-webtutorial.png" alt="libreta web tutorial" /> Sitio Web desarrollado como <strong>Proyecto Socio-Tecnológico</strong> por estudiantes del <strong>Colegio Universitario de Caracas</strong>, del trayecto 3 del turno de la noche.</p>
	</article>
